...
func (w *WServices) RestaurantCookingProcess() {
...
func (w *WServices) DeliveryPersonAssignProcess() {
	ctx := context.Background()
...
func (w *WServices) DeliveryPersonPickupProcess() {
	ctx := context.Background()
...
func (w *WServices) CustomerProcess() {
